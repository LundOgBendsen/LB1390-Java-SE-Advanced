...
public class TestInnerClass {
	...
	public static void main(final String[] args) {
		...
		System.out.print("action01.getAccount() == account01 returns: ");
		System.out.println(action01.getAccount() == account01);

		System.out.print("action01.getAccount() == account02 returns: ");
		System.out.println(action01.getAccount() == account02);

		System.out.print("action02.getAccount() == account01 returns: ");
		System.out.println(action02.getAccount() == account01);

		System.out.print("action02.getAccount() == account02 returns: ");
