/*
  * Shows example of user interface that 'hangs' while the program behind is working.
  * That is an example of how user interfaces would be without the use of threads.
  *
  * See ResponsiveGUI.java for solution.
  */
