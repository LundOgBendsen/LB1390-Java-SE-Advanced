package dk.lundogbendsen.javase8advanced.io.ex06.filesystem;
...
public class WorkingWithDirectories
{
  public static void main(String[] args) throws IOException
  {
    ...
    try (PrintWriter o = new PrintWriter(new OutputStreamWriter(System.out));)
    {
      ...
      File thisSourceFile = new File("."+File.separator+"src"+File.separator+packageName+File.separator+"WorkingWithDirectories.java");
      try (FileReader fr = new FileReader(thisSourceFile);
