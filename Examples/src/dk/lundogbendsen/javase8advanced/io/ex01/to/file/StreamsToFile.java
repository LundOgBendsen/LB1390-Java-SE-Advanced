package dk.lundogbendsen.javase8advanced.io.ex01.to.file;
...
public class StreamsToFile
{
  ...
  {
    // OUTPUT TO File
    try (FileOutputStream fos = new FileOutputStream("uhhhh.dat"); DataOutputStream dos = new DataOutputStream(fos);)
    {
      dos.writeInt(12);
    }
