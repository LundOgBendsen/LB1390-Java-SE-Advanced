...
public class InspectingClasses
{
  ...
  public static void main(final String[] args)
  {
    try
    {
      ...
      if (carClass.getSuperclass() == vehicleClass)
      { //true
        System.out.println("Car extends Vehicle");
      }
      if (vehicleClass.getSuperclass() == Object.class)
      { //true
      ...
      if (supertypesOfCar[0] == canCrossLandInterface)
      { //true
      ...
      System.out.println("Car[].class.getComponentType() == Car.class = " + (Car[].class.getComponentType() == Car.class));
