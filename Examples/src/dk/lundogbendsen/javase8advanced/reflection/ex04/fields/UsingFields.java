...
public class UsingFields
{
  ...
  public static void main(final String[] args) throws IllegalArgumentException, SecurityException, IllegalAccessException, NoSuchFieldException
  {
    ...
    System.out.println("Error in value of static field PI_APPROX is " + Math.abs(valueOfPi-Math.PI) / Math.PI * 100.0 + " %");
  }
}
