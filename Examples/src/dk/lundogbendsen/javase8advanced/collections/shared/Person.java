...
public class Person implements Comparable<Person>, Cloneable
{
  ...
  {
    String[] firstNames = { "Ingrid", "Dorthe", "Finn", "Torben", "Troels", "Gerda", "Ole", "Lena", "Flemming", "Anne", "Tessa", "Niels", "Per" };
    String[] lastNames = { "Falk", "Andriansen", "Berg", "Christensen", "Eliasen", "Grøndahl", "Hemdrup", "Larsen", "Møller", "Pedersen", "Vilmarsen" };
    try
    {
      Thread.sleep(10);
    }
  ...
  public int compareTo(final Person other)
  {
    ...
    if (this.bornIn < other.bornIn) { return -1; }
    if (this.bornIn > other.bornIn) { return 1; }
