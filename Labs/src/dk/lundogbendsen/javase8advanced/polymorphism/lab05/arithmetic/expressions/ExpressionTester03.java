...
public class ExpressionTester03 {
	...
	public static void main(final String[] args) {
		...
		/*
		 * Expression e1 = new Sum(new Number(3), new Number(4)); Expression e2 = new
		 * Multiplication(e1, new Number(2)); Expression e3 = new Division(e2, new
		 * Number(5)); Expression e4 = new Subtraction(new Number(324), e3);
		 *
