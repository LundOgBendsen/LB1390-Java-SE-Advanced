package dk.lundogbendsen.javase_advanced.io.lab03.filesystem;
...
public class FileInfo {
	...
	public static void main(final String[] args) {
		if (args.length == 0)
			throw new IllegalArgumentException("You need at least 1 argument");

		File file = new File(args[0]);
		if (!file.exists())
			throw new IllegalArgumentException("Filen: " + args[0] + " does not exist!!");
		if (!file.isDirectory())
			throw new IllegalArgumentException("Filen: " + args[0] + " is not a directory!!");
