...
public class Moon {
	...
	public Moon(final String name, final String planetName, final double diameterKM, final double massKG,
			final double semimajorAxisKM, final double orbitalPeriodD, final boolean retrogradeMotion) {
		super();
		this.name = name;
