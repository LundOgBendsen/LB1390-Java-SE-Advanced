...
public class Person implements Cloneable, Comparable<Person>
{
  ...
  public boolean equals(final Object obj)
  {
    ...
    return (this.isMale == other.isMale) && safeEquals(this.name, other.name) && this.weight == other.weight && this.birthYear == other.birthYear;
  }
  ...
  private boolean safeEquals(final Object o1, final Object o2)
  {
    ...
    if (null != o1 && null == o2) return false;
    if (null != o1 && null != o2) return o1.equals(o2);
  ...
  {
    if (o == null) { throw new NullPointerException("Parameter obj was null"); }
    if (this == o) { return 0; }
