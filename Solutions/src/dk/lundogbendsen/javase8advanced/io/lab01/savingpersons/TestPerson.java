...
public class TestPerson
{
  public static void main(final String[] args) throws Exception
  {
    ...
    System.out.println("Gemmer p1 i tekst-form (UTF-16) i filen person.txt");
    ...
    System.out.println("Gemmer p1 i tekst-form (ASCII) i filen person.txt");
    p1.saveAsText("person.txt", "ASCII");
    System.out.println("Henter Person p5 fra tekst-form fra filen person.txt");
